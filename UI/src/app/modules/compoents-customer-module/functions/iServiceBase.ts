...
export class iServiceBase {
    ...
    async postDataAsyncTest(url,inputData): Promise<any> {
        // Get IP và URL

        const response = await this.httpClient.post(url, inputData).toPromise();
        document.body.style.cursor = 'default';
        return response;
    }
    public postDatatest(url, inputData): Observable<any> {
        try {
            document.body.style.cursor = 'default';
            return this.httpClient.post(url, inputData).pipe(catchError(this.handleError));
        } catch (error) {
            document.body.style.cursor = 'default';
            console.log(error);
            return null;
    ...
    // async postDataAxiosAsync(service, api, inputData, ignoreLoading?: boolean, responseType?: string): Promise<any> {
    //     try {
    //         // Get IP và URL
    //         service = this.getURLService(service);
    ...
    //         }
    //         const url = `${service}${api}`;
    //         const response = await this.axiosClient.request<any>({
	// 			method: "post",
	// 			url: url,
	// 			params: inputData
	// 		});
    ...
    getURLService(phanhe) {
        try {
            ...
            switch (phanhe) {
                ...
                case API.PHAN_HE.CUDAN: {
                    return localStorage.getItem('APIGATEWAY') + '/Cudan/';
                }
                ...
                case API.PHAN_HE.NHANVIEN: {
                    return localStorage.getItem('APIGATEWAY') + '/Nhanvien/';
                }
                case API.PHAN_HE.TOANHA: {
                    return localStorage.getItem('APIGATEWAY') + '/Toanha/';
                }
                default: {
                    return '';
                }
