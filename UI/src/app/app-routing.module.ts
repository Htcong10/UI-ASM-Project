...
const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'QTriToaNha',
                loadChildren: () => import('./modules/quan-tri-toa-nha-module/quan-tri-toa-nha.module').then(m => m.QuanTriToaNhaModule),
            },
            // Quản trị danh mục module
            {
                path: 'QTriCuDan',
                loadChildren: () => import('./modules/quan-tri-cu-dan-module/quan-tri-cu-dan.module').then(m => m.QuanTriCuDanModule),
            },
